...
Electrical Load Monitoring & Billing Simulator MID SEMESTER CAPSTONE PROJECT Name:Tokoli Elliot Student ID:01241386D Course: EEE 227 (PT) Programme: HND Electrical Engineering (Level 200) Development Environment: VS Code (Windows) Programming Language: C++ Data Storage: Text File using fstream
Project Overview
